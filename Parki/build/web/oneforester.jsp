<%-- 
    Document   : oneforester
    Created on : 02.12.2016, 20:09:38
    Author     : Masha
--%>
...
<% request.setCharacterEncoding("UTF-8");
    ...
    f=new Forester();
    f=f.Select(Integer.parseInt(request.getParameter("forester")));
}%>
...
if(request.getParameter("update")!=null){
    f=new Forester(Integer.parseInt(request.getParameter("id")),request.getParameter("name").trim(),request.getParameter("surname").trim(),request.getParameter("putronumic").trim(),request.getParameter("phone").trim(),request.getParameter("email").trim());
    ...
    <body>
        ...
        <nav>
            <ul>
                ...
                <li class="now"><a href="forester.jsp">лесники</a></li>
        ...
        <div class="container" style="margin-top:45px">
            <section class="back">
                <a href="forester.jsp"><button>к списку лесников</button></a>
            </section>
            <article id="updateforester">
                <span class="good"><%=result%></span>  
             <form name="updateforester" method="POST">
                    <h3>Изменить данные</h3>
                    <input type="hidden" name="id" value="<%=f.getForesterID()%>">
